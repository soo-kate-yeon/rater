...
class VocabularyFeatureExtractor:
    ...
    def extract(self, transcript: str, reference_text: str | None = None) -> VocabularyFeatures:
        """
    ...
    def _calculate_cvamax(self, transcript: str, reference_text: str | None) -> float | None:
        """
