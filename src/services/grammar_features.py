...
class GrammarFeatureExtractor:
    ...
    def _calculate_poscvamax(self, doc: "Doc", reference_text: str | None) -> float | None:
        """
    ...
    def _calculate_dependent_clauses(self, doc: "Doc") -> float:
        ...
        for root in root_verbs:
            ...
            dependents = [child for child in root.children if child.dep_ in dependent_clause_deps]
