...
async def test_connection():
    # 정확한 Connection String (새 비밀번호)
    database_url = "postgresql+asyncpg://postgres:AIYS6s81EGtVLfW1@db.fgbhcmrpwinlogjpwivp.supabase.co:5432/postgres"
    ...
    try:
        async with engine.connect() as conn:
            ...
            if tables:
                ...
                print("✓ Public 스키마에 테이블이 없습니다. (새 프로젝트 - 정상)")
